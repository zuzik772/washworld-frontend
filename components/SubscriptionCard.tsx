...
const SubscriptionCard: React.FC<SubscriptionCardProps> = ({
  ...
  const [userMembership, setUserMembership] = useState("Premium");
    ...
    <ScrollView className="h-screen mb-32">
      <View
        style={{
          ...
          opacity: subscription.name === userMembership ? 1 : 0,
        }}
      ...
      <View
        style={{ opacity: subscription.name === userMembership ? 1 : 0 }}
        className="flex mr-2 "
      >
          ...
          <View className="border-2 border-secondaryOrange p-5 mr-2 ml-2 ">
            ...
            <View className="flex items-center my-5">
              ...
              <Text className="text-sm mt-2 text-center text-primaryWhite">
                Upgrade for {subscription.price - 169}kr
              </Text>
            </View>
          </View>
        </>
